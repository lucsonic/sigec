...
<?php
if ($permissao['permissoes']['fornecedores'] == '0') {
?>
    ...
    <body>
        <div class='container-fluid' style="padding-top: 0px;">
            <div class="barra" style="margin-bottom: 5px;">
                <div class="titulos">Fornecedores cadastrados</div>
                <img src="<?= base_url(); ?>/assets/img/linhah.png" width="100%">
            </div>
            <a class="btn cortema" id="btn_novo" Onclick="window.location = 'criar'"><span class="fas fa-truck-moving"></span>&nbsp;&nbsp;Novo Fornecedor</a>
            <br />
            <br />
                ...
                <table id="tblDados" class="table table-striped table-bordered table-hover" style="width: 100%">
                    ...
                    <tbody id="dados">
                        ...
                        ?>
                                <tr>
                                    <td>
                                        <a href="visualizar?id=<?= $fornecedor['idfornecedor']; ?>"><?php echo $fornecedor['nomefantasia']; ?></a>
                                    </td>
                                    <td>
                                        <?php echo $fornecedor['endereco'] . ', ' . $fornecedor['bairro'] .  ' - ' . $fornecedor['cidade'] . '/' . $fornecedor['uf']; ?>
                                    </td>
                                    ...
                                    <td width=5px style="text-align: center">
                                        <div data-toggle="tooltip" title="Editar">
                                            <span class="btn btn-sm btn-primary" Onclick="window.location = 'editar?id=<?php echo $fornecedor['idfornecedor']; ?>'">
                                    ...
                                    <?php if ($fornecedor['ativo'] == 1) { ?>
                                        <td width=5px style="text-align: center">
                                            <div data-toggle="tooltip" title="Desativar">
                                                <span class="btn btn-sm btn-danger" Onclick="window.location = 'desativar?id=<?php echo $fornecedor['idfornecedor']; ?>&nome=<?php echo $fornecedor['nomefantasia']; ?>'">
                                    ...
                                    <?php } else { ?>
                                        <td width=5px style="text-align: center">
                                            <div data-toggle="tooltip" title="Reativar">
                                                <span class="btn btn-sm btn-warning" Onclick="window.location = 'reativar?id=<?php echo $fornecedor['idfornecedor']; ?>&nome=<?php echo $fornecedor['nomefantasia']; ?>'">
